...
bot.on("message", async message => {
    ...
    if (command === 'help') {
        const helpEmbed = new MessageEmbed()
            ...
            .addField("Prefix","`>`")
            .addField("Moderation", "`kick` `ban` `mute` `unmute` `hackban` `unban` `nuke` `clean` `purge` `softban` `warn` `delwarn` `warnings` `clearwarns`")
            ...
            .addField("XP", "`level`")
            .setImage("https://static.wikia.nocookie.net/aesthetics/images/3/30/E.jpg/revision/latest/top-crop/width/360/height/450?cb=20210215214216")
